...
nix run github:skorpland/postgres#start-server 15
```
...
nix run github:skorpland/postgres/<some commit hash>#start-server 15
```
...
nix run github:skorpland/postgres#start-server 15 &
sleep 5
nix run github:skorpland/postgres#start-client 16
```
