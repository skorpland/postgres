...
INSERT INTO auth.users (id, "role", email)
    VALUES (gen_random_uuid (), 'test_user_role', 'bob@skorpland.com')
RETURNING
    * \gset bob_

INSERT INTO auth.users (id, "role", email)
    VALUES (gen_random_uuid (), 'test_user_role', 'alice@skorpland.com')
RETURNING
    * \gset alice_

INSERT INTO auth.users (id, "role", email)
    VALUES (gen_random_uuid (), 'test_admin_role', 'admin@skorpland.com')
RETURNING
    * \gset admin_
